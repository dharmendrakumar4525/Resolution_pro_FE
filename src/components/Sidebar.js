        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Resolution Pro" link={Routes.DashboardOverview.path} image={ReactHero} />

              {/* <NavItem title="Overview" link={Routes.DashboardOverview.path} icon={faChartPie} /> */}
           
              <CollapsableNavItem eventKey="tables/" title="Resolution" icon={faTable}>
                <NavItem title="Circular Resolution" link={Routes.BootstrapTables.path} />
                <NavItem title="Template Group" link={Routes.LoginPage.path} />
                <NavItem title="Meeting Template" link={Routes.BootstrapTables.path} />
                <NavItem title="Meeting Agenda" link={Routes.BootstrapTables.path} />
                <NavItem title="Meeting Agenda Template" link={Routes.BootstrapTables.path} />
                <NavItem title="Committee Members" link={Routes.BootstrapTables.path} />
              ...
              <CollapsableNavItem eventKey="components/" title="Master" icon={faBoxOpen}>
                <NavItem title="Users" link={Routes.Toasts.path} />
                <NavItem title="Customer Maintenance" link={Routes.Tooltips.path} />
              </CollapsableNavItem>
